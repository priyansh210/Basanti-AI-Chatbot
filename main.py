...
while True:
    prompt = "Schedule a meeting with Ashwin tomorrow at 9pm" #add funtion here to get input
    ...
    match broken_query['FUNCTION']:#
        ...
        case "ADD TO SCHEDULE":
            ...
            wf.checkNecessaryParams(broken_query, necessary_params)
            tele_bot.sendTelegramMessage(broken_query["WHO"], broken_query["WHAT"]+" "+broken_query["WHEN"].isoformat()+" "+broken_query["WHERE"])
